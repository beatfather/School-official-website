...
function show(anything){
    let elementById = document.getElementById("textbox1");
    elementById.value=anything;
}
function show1(anything){
    let elementById = document.getElementById("textbox2");
    elementById.value=anything;
}
...
// 轮播图的图片地址与跳转链接
let links=[
    {'image':'../imagebox/1.png','target':'#1'},
    {'image':'../imagebox/2.png','target':'#2'},
    {'image':'../imagebox/3.png','target':'#3'},
