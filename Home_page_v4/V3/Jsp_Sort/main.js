{
	class Details {
		constructor() {
			...
			document.getElementById('stu-in').appendChild(this.DOM.details);
			this.init();
		}
		init() {
	...
	class Item {
		constructor(el) {
			this.DOM = {};
			this.DOM.el = el;
			this.DOM.product = this.DOM.el.querySelector('.stuinfo');
			this.DOM.productBg = this.DOM.product.querySelector('.stuinfo__bg');

			this.info = {
				description: this.DOM.product.querySelector('.stuinfo__description').innerHTML
			};
